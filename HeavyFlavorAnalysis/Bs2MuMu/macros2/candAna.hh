...
public:
  ...
  virtual double      doTriggerMatchingR_OLD(TAnaTrack *pt, bool anyTrig, int hlt1, int hlt2); // match a single track to HLT
  ...
  double ftmp7, ftmp8, ftmp9, ftmp10;
  int ftmp11, ftmp12;
  int    fHltMu1Id,fHltMu2Id ;
